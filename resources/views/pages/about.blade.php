        ...
        <div class='row mini-list'>
            <?php
                $items = [
                    ...
                    //Captain
                    ['style' => 'background-size: cover;', 'img' => 'img/site/about/The Captain.jpg', 'text' => 'COMANDANTE di LUNGO CORSO. Diplomato con il massimo dei voti presso ITN Nino Bixio di Piano do Sorrento. Ha navigato per 18 anni con la compagnia MSC e attualmente operativo con la GRIMALDI Group. Ha abbracciato il progetto SOGNIAMO IN GRANDE come preparatore Tecnico degli Allievi agli esami di patentino e come Tutor del progetto per gli aspetti operativi di bordo.'],
